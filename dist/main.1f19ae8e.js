...
var renderElem = function renderElem(vNode) {
  // create the element
  // e.g. <div></div>
  var $el = document.createElement(vNode.tagName); // add all attributes as specified in vNode.attrs
  // e.g. <div id="app"></div>

  Object.entries(vNode.attrs).forEach(function (_ref) {
...
var vApp = (0, _createElement.default)('div', {
  id: 'app',
  children: ['Hello world', // represents TextNode
